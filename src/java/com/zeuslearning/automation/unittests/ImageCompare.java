...
public class ImageCompare {
    ...
    public ImageCompare() {
        ...
        factorD = 10;
        match = false;
        debugMode = 0; // 1: textual indication of change, 2:
                       // difference of factors
    }

    /* create a runable demo thing. */
    // public static void main(String[] args) throws FileNotFoundException {
    public boolean imageComparator(String file1, String file2) throws FileNotFoundException {
